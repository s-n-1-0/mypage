<template>
  <div id="timeline" class="mx-10">
    <h1 class="text-2xl pt-1 font-bold" style="color: #dd1f1f">Activity</h1>
    <hr />
    <ol class="relative border-l border-gray-200 dark:border-gray-700">
      ...
      >
        ...
        <time
          ...
          >{{ getTimeText(item.pubDateMs) }}</time
        >
        ...
        <p
          class="text-base font-normal text-gray-500 dark:text-gray-400 text-end"
        >
